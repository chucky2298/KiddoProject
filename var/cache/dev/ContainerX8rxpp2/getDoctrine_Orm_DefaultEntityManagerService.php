...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\EventsBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ReclamationBundle\\Entity')]);

$b->addDriver($c, 'EventsBundle\\Entity');
$b->addDriver($c, 'ReclamationBundle\\Entity');

$a->setEntityNamespaces(['EventsBundle' => 'EventsBundle\\Entity', 'ReclamationBundle' => 'ReclamationBundle\\Entity']);
