...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EventsBundle/Resources/views'), '!Events');
        $instance->addPath(($this->targetDirs[3].'\\src\\GererEnfantBundle/Resources/views'), 'GererEnfant');
        $instance->addPath(($this->targetDirs[3].'\\src\\GererEnfantBundle/Resources/views'), '!GererEnfant');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'GererEnfantBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\GererEnfantBundle'),
            ...
            case 'brochures_directory': $value = ($this->targetDirs[3].'/web/back'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'GererEnfantBundle' => 'GererEnfantBundle\\GererEnfantBundle',
